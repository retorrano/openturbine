...
class Turbine2DSchematic:
    ...
    def draw_hub(self):
        ...
        hub = Circle(
            (0, self.hub_height + self.rotor_diameter * 0.04),
            hub_radius,
            facecolor="#CCCC00",
            edgecolor="black",
            linewidth=2,
    ...
    def draw_blades(self, angle=None):
        ...
        chord_points = np.array([[3.5, 4.1, 4.3, 3.5, 2.5, 1.7, 1.0, 0.65]])
    ...
    def draw_force_diagram(self):
        ...
        inset_ax.arrow(
            0, 0, drag_arrow[0], drag_arrow[1], head_width=0.2, head_length=0.1, fc="red", ec="red"
        )
...
def create_schematic_plot(
    rotor_diameter=126.0, hub_height=90.0, num_blades=3, wind_speed=8.0, blade_angle=0.0
):
